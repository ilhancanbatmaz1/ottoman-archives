...
export const AdminAnalytics = () => {
    ...
    // Most popular documents (based on tokens count for now)
    ...
    // Document distribution by difficulty
        ...
        <AdminLayout>
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Sistem istatistikleri ve genel bakış</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <StatCard
                        ...
                        icon={BookOpen}
                        color="green"
                        subtitle="Etiketlenmiş kelimeler"
                    />
                    <StatCard
                                ...
                                recentReports.map(report => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between mb-1">
                                            ...
                                            <span className={`text-xs px-2 py-0.5 rounded font-bold ${report.status === 'pending'
                                                ...
                                                {report.status === 'pending' ? 'Bekliyor' :
                                                    report.status === 'accepted' ? 'Kabul' : 'Red'}
                                            </span>
                                        </div>
